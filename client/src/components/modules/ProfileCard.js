  ...
  return (
    <div className="Card-container">
      <div className="Card-story">
        ...
        <p className="Card-storyContent"><span className="u-bold">Spots Filled:</span> <span className="u-colorPrimary">{props.user_googleId_joined.length - 1} / {props.maxPeople}</span></p>
        <br></br>
