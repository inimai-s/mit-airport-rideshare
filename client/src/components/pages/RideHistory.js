...
const RideHistory = (props) => {
  ...
  if (props.user_googleid && props.user_name){
    ...
    if (hasJoinedRides) {
      ...
      rideHistoryModal = <div><br></br><span class="u-bold">You don't have any completed rides yet :D</span></div>;
    }
  }else{
    masterModal=<>
      <h1>My Ride History</h1>
  ...
  return (
    <>
      <Container className="u-marginTopPage u-marginBottomPage">{masterModal}{rideHistoryModal}</Container>
    </>
  );
};
